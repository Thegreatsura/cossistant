        ...
        return {
                ...
                setTyping({
                        ...
                        if (!isTyping) {
                                clearTimer(key);
                                store.setState((state) =>
                                        removeEntry(state, conversationId, key)
                                );
                                return;
                        }
...
export function setTypingState(store: TypingStore, options: SetTypingOptions): void {
        store.setTyping(options);
}

export function clearTypingState(store: TypingStore, options: TypingOptions): void {

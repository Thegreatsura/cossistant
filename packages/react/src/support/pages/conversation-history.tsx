...
export const ConversationHistoryPage: React.FC = () => {
  ...
  return (
    <>
      ...
      <div className="relative flex h-full flex-col gap-10 overflow-y-auto pt-20">
      ...
      <div className="pointer-events-none absolute inset-x-0 bottom-0 h-40 bg-gradient-to-t from-co-background-100 via-co-background-100/50 to-transparent" />
    </>
  );
};

...
export const WebsiteInstallationTargetEnum = {
  NEXTJS: "nextjs",
  REACT: "react",
} as const;
...
export type WebsiteStatus =
  (typeof WebsiteStatusEnum)[keyof typeof WebsiteStatusEnum];

export type WebsiteInstallationTarget =
  (typeof WebsiteInstallationTargetEnum)[keyof typeof WebsiteInstallationTargetEnum];

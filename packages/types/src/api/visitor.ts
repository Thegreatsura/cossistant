...
export const visitorProfileSchema = z.object({
  ...
  name: z.string().nullable().openapi({
    description:
      "The visitor's name from their linked contact (if identified).",
    example: "John Doe",
  }),
  email: z.string().nullable().openapi({
    description:
      "The visitor's email from their linked contact (if identified).",
    example: "john.doe@example.com",
  }),
  avatar: z.string().nullable().openapi({
    description:
      "The visitor's avatar URL from their linked contact (if identified).",

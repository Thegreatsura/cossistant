  ...
  return (
    <>
      <div className="flex min-h-screen flex-col gap-8 pt-32 md:flex-row md:items-center lg:pt-0">
        <div className="mx-auto mb-20 flex flex-col gap-20 lg:mx-auto lg:mb-0 lg:flex-row">
          ...
          <div className="hidden w-full items-center justify-center md:flex lg:justify-start">
            <ComponentPreview
              name="support"
              sizeClasses="md:aspect-auto md:h-[70vh] md:w-[600px] max-h-[800px]"
              withOrnament
            />
          </div>
        </div>

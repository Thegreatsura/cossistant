	...
	return (
		<div className="relative flex min-h-screen items-center bg-background p-20">
			...
			>
				<Image
					alt="Playground"
					className="absolute inset-0 z-0 object-cover opacity-10 grayscale-100"
					height={2400}
					src="https://cdn.cossistant.com/neom-t3dlLOhdEzs-unsplash.jpg"
					width={1600}
				/>
			</motion.div>
			<div className="z-10 h-fit w-full border border-primary/10 border-dashed p-4 md:w-1/3">

...
const websiteInformationFormSchema = z.object({
        name: z
                .string({ required_error: "Enter your website name." })
                .trim()
        ...
        contactEmail: z
                .union([
                        ...
                        z
                                ...
                                .max(320, {
                                        message:
                                                "Email address must be 320 characters or fewer.",
                                }),
                ])
                .default(""),
        domain: z
                .string({ required_error: "Enter your domain." })
                .trim()
                        ...
                        trpc.website.update.mutationOptions({
                                onSuccess: async (updatedWebsite) => {
                                        await Promise.all([
                                                ...
                                                queryClient.invalidateQueries({
                                                        queryKey:
                                                                trpc.website.developerSettings.queryKey({
                                                                        slug: websiteSlug,
                                                                }),
                                                }),
                                        ]);
                                        ...
                                        form.reset({
                                                ...
                                                contactEmail:
                                                        updatedWebsite.contactEmail ?? "",
                                                logo: updatedWebsite.logoUrl ?? null,
                                        });

                                        setDomainBaseline(
                                                updatedWebsite.domain.trim().toLowerCase()
                                        );
                ...
                async (file: File): Promise<Partial<AvatarInputValue>> => {
                        try {
                                const uploadDetails = await createSignedUrl({
                                        ...
                                        fileName: file.name,
                                        basePath: ["websites", websiteId, "logo"],
                                });

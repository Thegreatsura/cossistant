          ...
          {keyCreated && lastCreatedKey ? (
            <div className="flex flex-col gap-4">
              ...
              <p className="text-muted-foreground text-sm">
                Please add this key to your environment file and keep it secure.
              </p>
              <DashboardCodeBlock
              ...
              {lastCreatedKey.keyType === APIKeyType.PRIVATE && (
                <Alert className="mt-10" variant="info">
                  ...
                  <AlertDescription className="space-y-3">
                    <p>
                      This key will not be shown again. Keep it secure and store
                      it in your secret manager before closing this sheet. If
                      you lose it, you'll need to create a new key.
                    </p>
                  </AlertDescription>
                </Alert>
              )}
            ...
            <Form {...form}>
              ...
              >
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="mb-2">Key type</FormLabel>
                      <FormControl>
                        <RadioGroup

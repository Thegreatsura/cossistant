        ...
        const onSubmit = useCallback(
                async (values: NotificationFormValues) => {
                        ...
                        const nextSettings = data.settings.map((setting) => {
                                const definition =
                                        MEMBER_NOTIFICATION_DEFINITION_MAP.get(setting.channel);
                                ...
                                <div className="space-y-1 text-sm text-muted-foreground">
                                        ...
                                        {definition.requiresSetup && !current?.config && (
                                                <p className="text-xs text-amber-600 dark:text-amber-400">
                                                        Set up browser push credentials before enabling
                                                        alerts.
                                                </p>
                                        )}
                                </div>
                        ...
                        >
                                <div className="space-y-6">
                                        <FormField
                                                ...
                                                name={`${MemberNotificationChannel.EMAIL_MARKETING}.enabled` as const}
                                                render={({ field }) => (
                                        ...
                                        <FormField
                                                control={form.control}
                                                name={`${MemberNotificationChannel.EMAIL_NEW_MESSAGE}.enabled` as const}
                                                render={({ field }) => (
                                                        <FormItem className="space-y-3">
                                                                <div className="flex items-center justify-between gap-6">
                                                                        <div className="space-y-3">
                                                                                ...
                                                                                <FormField
                                                                                        control={form.control}
                                                                                        name={`${MemberNotificationChannel.EMAIL_NEW_MESSAGE}.delayMinutes` as const}
                                                                                        render={({ field: delayField }) => (
                                                                                                <FormItem>
                                                                                                        <FormLabel>
                                                                                                                Delay before emailing
                                                                                                        </FormLabel>
                                                                                                        <FormControl>
                                                                                                                <Input
                                                                                                                        {...delayField}
                                                                                                        ...
                                                                                                        <FormDescription>
                                                                                                                Minutes to wait after a
                                                                                                                new message before sending an
                                                                                                                email.
                                                                                                        </FormDescription>
                                                                                                        <FormMessage />
                                                                                                </FormItem>
                                        ...
                                        <FormField
                                                control={form.control}
                                                name={`${MemberNotificationChannel.BROWSER_PUSH_NEW_MESSAGE}.enabled` as const}
                                                render={({ field }) => (
                                                        <FormItem className="space-y-3">
                                                                <div className="flex items-center justify-between gap-6">
                                                                        <div>

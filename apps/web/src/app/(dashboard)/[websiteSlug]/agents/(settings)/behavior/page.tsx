...
export default function BehaviorPage() {
	...
	// Note: Form loads with defaults since trpc doesn't expose behaviorSettings yet
	// TODO: Load saved behavior settings from API when available

	const onSubmit = (data: BehaviorFormData) => {
		// TODO: Implement backend endpoint for saving behavior settings
		// For now, show success toast as placeholder
		toast.success("Behavior settings saved (preview only)");
		console.log("Behavior settings to save:", data);
	};

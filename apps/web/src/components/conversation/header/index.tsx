...
export function ConversationHeader() {
  ...
  return (
    <PageHeader className="pl-3.5 z-10 border-b border-primary/10 bg-background dark:bg-background-100 2xl:border-transparent 2xl:bg-transparent 2xl:dark:bg-transparent">

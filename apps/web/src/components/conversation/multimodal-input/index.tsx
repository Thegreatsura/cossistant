...
import * as Primitive from "@cossistant/react/primitive";
...
export const MultimodalInput: React.FC<MultimodalInputProps> = ({
	...
	return (
		<div className="2xl:max-w-3xl xl:max-w-2xl max-w-xl mx-auto w-full absolute bottom-4 left-0 right-0 px-4 lg:px-0">
			<form className="flex flex-col gap-2" onSubmit={handleFormSubmit}>
				...
				{/* Input area */}
				<div className="flex flex-col rounded border dark:border-border/50 bg-background-100 dark:bg-background-400 drop-shadow-xs">

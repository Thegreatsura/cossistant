      ...
      content={
        isAway
          ...
          : isOnline
            ...
            : `${fallbackName} last seen ${formatTimeAgo(lastOnlineAt ?? new Date())}`
      }
    >
      <div className="relative">
        ...
        {isOnline && (
          <div
            className={cn(
              "absolute -right-0.5 -bottom-0.5 size-2 rounded-full shadow hidden",
              {
                "bg-cossistant-green block": isOnline,
                "bg-cossistant-orange block": isAway,
              }
            )}
          />
        )}

...
// Simple hash function to generate consistent numeric hash from string
...
function BoringAvatar({
  ...
  // return consistent face and color index given the same string
  const { face, color, transform } = useMemo(() => {

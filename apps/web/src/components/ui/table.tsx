...
>(({ className, ...props }, ref) => (
	<thead
		className={cn("[&_tr]:border-primary/10 [&_tr]:border-b", className)}
		ref={ref}
		{...props}
	/>
));
...
>(({ className, ...props }, ref) => (
	<tfoot
		className={cn(
			"border-primary/10 border-t bg-background-secondary/50 font-medium text-muted-foreground [&>tr]:last:border-b-0",
			className
		)}
		ref={ref}
		{...props}

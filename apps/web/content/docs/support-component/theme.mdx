...
The widget automatically adapts to your site's color scheme. Add a `.dark` class to your layout or set `data-color-scheme="dark"` on the widget container.

```tsx
<Support className="dark" />
```

      ...
      conversations: result.conversations.map((conv) => ({
        ...
        lastMessage: conv.lastMessage
          ? {
              ...
              updatedAt: conv.lastMessage.updatedAt.toISOString(),
              deletedAt: conv.lastMessage.deletedAt
                ? conv.lastMessage.deletedAt.toISOString()
                : null,
            }
          : undefined,
      })),
      ...
      conversation: {
        ...
        lastMessage: conversation.lastMessage
          ? {
              ...
              updatedAt: conversation.lastMessage.updatedAt.toISOString(),
              deletedAt: conversation.lastMessage.deletedAt
                ? conversation.lastMessage.deletedAt.toISOString()
                : null,
            }
          : undefined,
      },

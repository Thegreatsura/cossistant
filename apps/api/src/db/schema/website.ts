...
export const websiteInstallationTarget = pgEnum(
  "website_installation_target",
  enumToPgEnum(WebsiteInstallationTargetEnum)
);

export const websiteStatus = pgEnum(
  "website_status",
  enumToPgEnum(WebsiteStatusEnum)
);
...
export const website = pgTable(
  "website",
  {
    ...
    installationTarget: websiteInstallationTarget("installation_target")
      .$defaultFn(() => WebsiteInstallationTargetEnum.NEXTJS)
      .notNull(),
    ...
    status: websiteStatus("status").default(WebsiteStatusEnum.ACTIVE).notNull(),
